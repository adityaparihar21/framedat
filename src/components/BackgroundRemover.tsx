    ...
    <div className="page-container py-6">
      ...
      {!sourceBlob ? (
        ...
        <div
          ...
          className="w-full max-w-[480px] mx-auto p-10 text-center cursor-pointer rounded-2xl border border-[--border-subtle] bg-[--bg-surface-1] hover:border-[--border-hover] hover:bg-[--bg-surface-2]/40 transition-all my-12"
        >
          <input
            ref={fileInputRef}
            type="file"
          ...
          <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-[--accent-blue-dim] border border-[--accent-blue-border] flex items-center justify-center text-[--accent-blue]">
          ...
          <button className="btn btn-primary text-xs py-2.5 px-6 font-semibold">
            Choose Photo
          </button>
        </div>
      ) : (
